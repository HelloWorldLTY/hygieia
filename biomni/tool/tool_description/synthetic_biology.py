description = [
    ...
    {
        "description": "Measure the expression level of targeted sequences in hepg2",
        "name": "expression_hepg2",
        "required_parameters": [
            {
                "default": None,
                "description": "The list of DNA sequences",
                "name": "sequence",
                "type": "list",
            }
        ],
    ...
    {
        "description": "Measure the expression level of targeted sequences in k562",
        "name": "expression_k562",
        "required_parameters": [
            {
                "default": None,
                "description": "The list of DNA sequences",
     ...
     {
        "description": "Measure the expression level of targeted sequences in sknsh",
        "name": "expression_sknsh",
        "required_parameters": [
            {
                "default": None,
                "description": "The list of DNA sequences",
